...
folderloc = '/data/shared/suhit/pg_gan/'
...
targetGraphNameWithExt = '/data/shared/suhit/pg_grid_sharpness_plot.png'
#targetGraphNameWithExt = 'bedroom11_grid_sharpness_plot.png' 
plot_title = 'Image Index vs Sharpness for Playground'
...
for ip in l1:
    ...
    for col in lst:
        for row in lst:
            ...
            pix = np.array(cropped_image.convert('1'))
            val = sharpness(pix)
